...
# Load datasets
sym_des = pd.read_csv(r"W:\Capstone\health_care\datasets\symtoms_df.csv")
precautions = pd.read_csv(r"W:\Capstone\health_care\datasets\precautions_df.csv")
workout = pd.read_csv(r"W:\Capstone\health_care\datasets\workout_df.csv")
description = pd.read_csv(r"W:\Capstone\health_care\datasets\description.csv")
medications = pd.read_csv(r"W:\Capstone\health_care\datasets\medications.csv")
diets = pd.read_csv(r"W:\Capstone\health_care\datasets\diets.csv")

# Load model
svc = pickle.load(open(r'W:\Capstone\health_care\svc.pkl', 'rb'))

# Helper function to get information based on predicted disease
def helper(dis):
